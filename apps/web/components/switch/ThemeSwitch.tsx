...
const ThemeSwitchComponent = styled(Switch)(({ theme }) => ({
	width: 58,
	height: 30,
	padding: 7,
...
export default function ThemeSwitch() {
	const { toggle, switchChecked } = useCustomTheme();

	return <ThemeSwitchComponent onChange={toggle} checked={switchChecked} />;
}
