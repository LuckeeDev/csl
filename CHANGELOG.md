...
## [2.17.7](https://github.com/LuckeeDev/csl/compare/v2.17.6...v2.17.7) (2022-04-28)



## [2.17.6](https://github.com/LuckeeDev/csl/compare/v2.17.5...v2.17.6) (2022-04-28)
...
* **prisma:** make relations required ([5d326d1](https://github.com/LuckeeDev/csl/commit/5d326d1989d558b0338feb8abfcbeeaf10ca9c96))
...
* **prisma:** add bookings in schema ([423d768](https://github.com/LuckeeDev/csl/commit/423d76813959d13e41719252cedce3d2bad6d389))
* **prisma:** add service account model ([5edd5ce](https://github.com/LuckeeDev/csl/commit/5edd5ce8d3e274655aaa364e0fed2e8b151a558a))
...
* **images:** add width and height in db schema ([f4e9783](https://github.com/LuckeeDev/csl/commit/f4e97837715f807571221f01115eb7725fbdfc56))
...
* **deps:** downgrade prisma adapter to 1.0.1 ([b17c2fd](https://github.com/LuckeeDev/csl/commit/b17c2fd355481cc630bb119fa41df0a6e4b3e8ec))
...
* **shop:** add very basic carousel ([c9711e0](https://github.com/LuckeeDev/csl/commit/c9711e013bf43ac561671ef2ad8d8dc71a7772ed))
* **shop:** add very basic carousel ([a3c4af5](https://github.com/LuckeeDev/csl/commit/a3c4af59f55bad61ccc8ce76d31f816ac1012f97))
* **shop:** create order model ([296cc33](https://github.com/LuckeeDev/csl/commit/296cc33d18f33661fa9be5909ef412d400c23959))
...
* changed back to actions/create-release ([d2bf4dc](https://github.com/LuckeeDev/csl/commit/d2bf4dc5705c13b29a8f26456bffa0cfbd799d09))
...
* removed automatic release notes ([5f2e734](https://github.com/LuckeeDev/csl/commit/5f2e734c1d29138a7468bb5f293897d06ecddd1c))
...
* removed dataProxy again ([56598d4](https://github.com/LuckeeDev/csl/commit/56598d45bb767d5f49f521525c0558e1b3ffdcae))
...
* :card_file_box: add prisma data proxy ([6276dd3](https://github.com/LuckeeDev/csl/commit/6276dd3cc167f9a605282b3361a5aed500651860))
...
* deploy admin and api separately ([b30ad2c](https://github.com/LuckeeDev/csl/commit/b30ad2c44967aa495d268d949b5dec709546f98e))
...
* disabled currently unsupported login methods ([ad98ec2](https://github.com/LuckeeDev/csl/commit/ad98ec2d8f651f601a69b0b886bb6b56d18d34af))
* display image and content preview in article ([d23265c](https://github.com/LuckeeDev/csl/commit/d23265c170c45a6887b8191ca7fdb9ef7b0569a3))
* fetch from new auth state in logged in guard ([2dafa23](https://github.com/LuckeeDev/csl/commit/2dafa23a9f578951d69689df7d77eba5f631a4e5))
* login and display user name ([407d8e7](https://github.com/LuckeeDev/csl/commit/407d8e712549407b25b345159ca503f6b2ba9828))
...
* next to 12.0.8 ([70a2186](https://github.com/LuckeeDev/csl/commit/70a2186905100cf3b1dc65ff137ac93d1ce65642))
...
* strapi env ([6c6aa81](https://github.com/LuckeeDev/csl/commit/6c6aa81db7471d4218583ec8d4d49be7d6adc484))
* temporary workaround for domain login limitation ([294087a](https://github.com/LuckeeDev/csl/commit/294087ab0513dd36bdd6c028fd6cdde2be0cd2c3))
* update products ([3499430](https://github.com/LuckeeDev/csl/commit/349943018a4d0c4b0bbf0738f172d2151cee4ccb))
* use logo as home link ([2592cbf](https://github.com/LuckeeDev/csl/commit/2592cbf61f6abca5ee7c6fd676e0fdd79492cb80))
...
* remove unused parts of the project ([a669904](https://github.com/LuckeeDev/csl/commit/a669904b05e9c3569350fad7fca9b112caf5b0cc))
...
* create and retrieve user ([8ff6632](https://github.com/LuckeeDev/csl/commit/8ff663232b1bdcffe13009c379a28dafc83ceed0))
...
* removed unused dependencies ([91e031f](https://github.com/LuckeeDev/csl/commit/91e031faa16f9bcb89c069b3bc13b37a003c3f21))
* save articles ([7a7c3a6](https://github.com/LuckeeDev/csl/commit/7a7c3a61bc556483f0e728b952151f5eefc81100))
...
* update logged in user ([295caef](https://github.com/LuckeeDev/csl/commit/295caefc4dd8beec4fd508e6d560f22fec4ef462))
...
* from now on, there are no other projects outside of the web folder
...
* added total to stats ([f460d3a](https://github.com/LuckeeDev/csl/commit/f460d3aa56c8c0cc41f06127f678dfb3c5c661c7))
...
* remove payments endpoint ([d369bef](https://github.com/LuckeeDev/csl/commit/d369bef09c983c81d1dcac882330ac38b125b26a))
* remove payments page ([56a2ecb](https://github.com/LuckeeDev/csl/commit/56a2ecb2b0b680b27fac93aafd00727b8e5fbafc))
...
* filter users before generating csv ([564aace](https://github.com/LuckeeDev/csl/commit/564aace7314368d1963da490dabb1815a64f1f00))
...
- specify ref in previous git tag ([67aa01b](https://github.com/LuckeeDev/csl/commit/67aa01bf0a7b390b108dcf4cce6899fb80df82a1))

## [1.8.28](https://github.com/LuckeeDev/csl/compare/v1.8.27...v1.8.28) (2021-03-24)

### Bug Fixes

- **ci:** trying another syntax ([dcf3aa8](https://github.com/LuckeeDev/csl/commit/dcf3aa8ba412b5b11826b75f01e3d2d91ed11e8f))
...
- redirects ([1d76e10](https://github.com/LuckeeDev/csl/commit/1d76e10a41ae26c032359a9dccbe5c5e3a3d16c7))
